...
public class Skill3Button : MonoBehaviour {
    ...
    public void SustainmentTimeInformationIcon()
    {
        for (int i = 0; i < stt.SustainmentTimeInformationIcon.Length; i++)
        {
            ...
            {
                stt.SustainmentTimeInformationIcon[0] = Instantiate(stt.skillBlessTime[2]) as GameObject;
            ...
            {
                stt.SustainmentTimeInformationIcon[1] = Instantiate(stt.skillBlessTime[2]) as GameObject;
            ...
            {
                stt.SustainmentTimeInformationIcon[2] = Instantiate(stt.skillBlessTime[2]) as GameObject;
            ...
            {
                stt.SustainmentTimeInformationIcon[3] = Instantiate(stt.skillBlessTime[2]) as GameObject;
            ...
            {
                stt.SustainmentTimeInformationIcon[4] = Instantiate(stt.skillBlessTime[2]) as GameObject;
            ...
            {
                stt.SustainmentTimeInformationIcon[5] = Instantiate(stt.skillBlessTime[2]) as GameObject;
